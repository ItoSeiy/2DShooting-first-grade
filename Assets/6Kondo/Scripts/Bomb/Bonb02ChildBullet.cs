...
{
    [SerializeField, Header("Enemy‚ÌBullet‚Ìƒ^ƒO")] string _enemyBulletTag = "Bullet";
    [SerializeField, Header("’Ç]‚µŽn‚ß‚éŽžŠÔ")] float _followStartTime = 2f;
    [SerializeField, Header("’Ç]‚ðI‚í‚éŽžŠÔ")] float _followFnishTime = 5f;
    float _timer = 0;
    Vector2 _oldDir;
    GameObject _enemy;
